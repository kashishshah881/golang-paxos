...
func main() {
	...
	flag.StringVar(&port,"p",":8001","Enter Port Number. Format:- ':<port_number>'")
	...
	flag.StringVar(&server_name,"server_name","Server01","Enter a Unique Servername with no spaces.")
	flag.Parse()
	RegisterService()
