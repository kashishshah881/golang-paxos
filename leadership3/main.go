...
func main() {
	...
	flag.StringVar(&port,"p",":8003","Enter Port Number. Format:- ':<port_number>'")
	...
	flag.StringVar(&server_name,"server_name","Server03","Enter a Unique Servername with no spaces.")
	flag.Parse()
	RegisterService()
